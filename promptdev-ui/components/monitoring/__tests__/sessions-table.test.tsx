...
import type { MonitoringSession, PaginatedResponse, MonitoringDashboard } from '@/lib/monitoring'
...
describe('SessionsTable', () => {
  it('shows empty state when sessions is undefined', () => {
    render(
      <SessionsTable sessions={undefined} onSelectSession={vi.fn()} />,
    )
  ...
  it('shows empty state when sessions.empty is true', () => {
    ...
    render(
      <SessionsTable sessions={empty} onSelectSession={vi.fn()} />,
    )
    expect(screen.getByText(/no sessions recorded yet/i)).toBeInTheDocument()
  })
  ...
  it('renders session rows', () => {
    ...
    render(
      <SessionsTable sessions={sessions} onSelectSession={vi.fn()} />,
    )
