...
vi.mock("media-chrome/react", () => ({
  ...
  MediaPlayButton: (props: Record<string, unknown>) => (
  ...
  MediaTimeDisplay: (props: Record<string, unknown>) => (
    <span data-testid="time-display" {...props} />
  ),
  MediaTimeRange: (props: Record<string, unknown>) => (
    <input data-testid="time-range" {...props} />
  ),
  MediaDurationDisplay: (props: Record<string, unknown>) => (
    <span data-testid="duration-display" {...props} />
  ),
  MediaMuteButton: (props: Record<string, unknown>) => (
    <button data-testid="mute-button" {...props} />
  ),
  MediaVolumeRange: (props: Record<string, unknown>) => (
    <input data-testid="volume-range" {...props} />
  ),
}));
