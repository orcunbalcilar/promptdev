...
describe("OpenInT3", () => {
  it("generates correct T3 Chat URL", () => {
    ...
    expect(link).toHaveAttribute(
      "href",
      expect.stringContaining("t3.chat/new"),
    );
    expect(link).toHaveAttribute(
      "href",
      expect.stringContaining("help+me+build"),
    );
...
describe("OpenInScira", () => {
  it("generates correct Scira URL", () => {
    ...
    expect(link).toHaveAttribute(
      "href",
      expect.stringContaining("explain+quantum"),
    );
    expect(link).toHaveAttribute("target", "_blank");
    expect(link).toHaveAttribute("rel", "noopener");
  });
...
describe("OpenInv0", () => {
  it("generates correct v0 URL", () => {
    ...
    expect(link).toHaveAttribute(
      "href",
      expect.stringContaining("create+a+dashboard"),
    );
    expect(link).toHaveAttribute("target", "_blank");
    expect(link).toHaveAttribute("rel", "noopener");
  });
...
describe("OpenInCursor", () => {
  it("generates correct Cursor URL", () => {
    ...
    expect(link).toHaveAttribute(
      "href",
      expect.stringContaining("cursor.com/link/prompt"),
    );
