...
vi.mock('@rive-app/react-webgl2', () => ({
  useRive: vi.fn().mockReturnValue({
    rive: null,
    RiveComponent: ({ className }: { className?: string }) => <div data-testid="rive" className={className} />,
  }),
...
vi.mock('motion/react', () => ({
  motion: { div: ({ children, ...props }: Record<string, unknown> & { children?: React.ReactNode }) => <div {...props}>{children}</div> },
