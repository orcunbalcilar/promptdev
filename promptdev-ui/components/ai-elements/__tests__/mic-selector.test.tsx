...
Object.defineProperty(globalThis.navigator, 'mediaDevices', {
  value: {
    enumerateDevices: vi.fn().mockResolvedValue([
      ...
      { kind: 'audioinput', deviceId: 'mic2', label: 'External Mic', groupId: '2' },
    ]),
...
describe('MicSelectorTrigger', () => {
  it('renders button', () => {
    ...
    expect(screen.getByRole('button', { name: /select microphone/i })).toBeInTheDocument()
  })
})

describe('MicSelectorLabel', () => {
  it('renders device label text', () => {
    const device = { kind: 'audioinput', deviceId: 'default', label: 'Default Mic', groupId: '1' } as MediaDeviceInfo
  ...
  it('renders device label with device id pattern', () => {
    const device = { kind: 'audioinput', deviceId: 'usb', label: 'USB Mic (1234:5678)', groupId: '1' } as MediaDeviceInfo
