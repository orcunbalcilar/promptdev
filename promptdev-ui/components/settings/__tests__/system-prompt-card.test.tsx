...
describe('SystemPromptCard', () => {
  it('renders the card title', () => {
    renderWithProviders(<SystemPromptCard userId="u1" profile={makeProfile()} />)
  ...
  it('pre-fills from profile', () => {
    ...
    expect(screen.getByLabelText('System Prompt')).toHaveValue('You are a helpful bot')
  })
  ...
  it('calls updateUserSettings on save', async () => {
    ...
    await user.click(screen.getByRole('button', { name: /save system prompt/i }))
  ...
  it('shows save button', () => {
    renderWithProviders(<SystemPromptCard userId="u1" profile={makeProfile()} />)
    expect(screen.getByRole('button', { name: /save system prompt/i })).toBeInTheDocument()
  })
