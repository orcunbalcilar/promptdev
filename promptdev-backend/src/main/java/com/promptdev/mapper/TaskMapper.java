...
public class TaskMapper {
    ...
    private TaskResponse.TaskResponseBuilder toResponseBuilder(Task task) {
        return TaskResponse.builder()
                ...
                .reviewEnabled(task.getReviewEnabled())
                .reviewModelId(task.getReviewModelId())
                .resumePrompt(task.getResumePrompt())
                .resumeCount(task.getResumeCount())
                .commitMessagePattern(task.getCommitMessagePattern())
