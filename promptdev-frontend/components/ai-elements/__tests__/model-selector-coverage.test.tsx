// /Users/orcun/projects/promptdev/promptdev-frontend/components/ai-elements/__tests__/model-selector-coverage.test.tsx
...
vi.mock("@/components/ui/command", () => ({
  ...
  CommandDialog: ({ children, ...props }: React.ComponentProps<"div">) => (
    <div data-testid="command-dialog" {...props}>{children}</div>
  ),
  ...
  CommandGroup: ({ children, ...props }: React.ComponentProps<"div">) => (
    <div data-testid="command-group" {...props}>{children}</div>
  ),
  ...
  CommandItem: ({ children, ...props }: React.ComponentProps<"div">) => (
    <div data-testid="command-item" {...props}>{children}</div>
  ),
  CommandList: ({ children, ...props }: React.ComponentProps<"div">) => (
    <div data-testid="command-list" {...props}>{children}</div>
  ),
...
vi.mock("@/components/ui/dialog", () => ({
  ...
  DialogTitle: ({ children, ...props }: React.ComponentProps<"span">) => (
    <span data-testid="dialog-title" {...props}>{children}</span>
  ),
...
describe("ModelSelectorInput (line 77)", () => {
  it("renders with merged className", () => {
    render(<ModelSelectorInput className="custom-class" placeholder="Search" />);
