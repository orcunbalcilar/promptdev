...
describe('VoiceSelectorGender – extended', () => {
  ...
  it('renders default icon for unrecognized value', () => {
    const { container } = render(<VoiceSelectorGender value={'unknown-gender' as 'male'} />)
    expect(container.querySelector('span')).toBeInTheDocument()
  })

  it('renders with custom className', () => {
    const { container } = render(<VoiceSelectorGender value="male" className="custom-gender" />)
...
describe('VoiceSelectorAccent – extended', () => {
  ...
  it.each(accentTests)('renders %s accent with correct flag emoji', (accent, emoji) => {
  ...
  it('children override emoji', () => {
    render(<VoiceSelectorAccent value="french">French Accent</VoiceSelectorAccent>)
    expect(screen.getByText('French Accent')).toBeInTheDocument()
  })

  it('applies custom className', () => {
    const { container } = render(<VoiceSelectorAccent value="american" className="accent-cls" />)
...
describe('VoiceSelectorAge', () => {
  ...
  it('applies custom className', () => {
    const { container } = render(<VoiceSelectorAge className="age-cls">30</VoiceSelectorAge>)
...
describe('VoiceSelectorName', () => {
  ...
  it('applies custom className', () => {
    const { container } = render(<VoiceSelectorName className="name-cls">Shimmer</VoiceSelectorName>)
...
describe('VoiceSelectorDescription', () => {
  it('renders description text', () => {
    render(<VoiceSelectorDescription>Warm and friendly</VoiceSelectorDescription>)
...
describe('VoiceSelectorBullet', () => {
  ...
  it('applies custom className', () => {
    const { container } = render(<VoiceSelectorBullet className="bullet-cls" />)
