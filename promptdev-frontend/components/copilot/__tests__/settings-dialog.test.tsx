...
describe('SettingsDialog', () => {
  ...
  it('opens dialog on trigger click', async () => {
    ...
    expect(screen.getByText('Configure the AI model and reasoning settings.')).toBeInTheDocument()
  })
  ...
  it('disables reasoning select when model does not support it', async () => {
    ...
    await user.click(screen.getByRole('button', { name: /settings/i }))
    expect(screen.getByText(/not supported by this model/i)).toBeInTheDocument()
  })
  ...
  it('enables reasoning select when model supports it', async () => {
    ...
    await user.click(screen.getByRole('button', { name: /settings/i }))
    expect(screen.queryByText(/not supported by this model/i)).not.toBeInTheDocument()
  })
})
