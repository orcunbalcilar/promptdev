...
describe('DailyOperationsChart', () => {
  ...
  it('renders the card when data is provided', () => {
    ...
    expect(screen.getByText('Operations over the selected time period')).toBeInTheDocument()
  })
})
...
describe('OperationsByTypeChart', () => {
  ...
  it('renders the card with entries', () => {
    ...
    expect(screen.getByText('Distribution of operation types')).toBeInTheDocument()
  })
})
...
describe('TopToolsChart', () => {
  ...
  it('renders the chart card', () => {
    ...
    expect(screen.getByText('Tool execution count and average duration')).toBeInTheDocument()
  })
})
...
describe('SessionsByModelChart', () => {
  ...
  it('renders the card with model data', () => {
    render(
      <SessionsByModelChart data={{ 'gpt-4': 10, 'claude-3': 5 }} />,
    )
